...
export function MarketplaceView() {
  ...
  const [apps, setApps] = useState<MarketplaceApp[]>([
    ...
    { id: 'app-2', name: 'Zodiac Auto-Responder', publisher: 'SalesPilot Labs', description: 'AI Agent that reads lead local times and responds during prime click-rate hours.', category: 'agents', rating: 4.9, downloads: 840, version: '1.2.0', latestVersion: '1.2.0', status: 'INSTALLED', icon: Bot },
